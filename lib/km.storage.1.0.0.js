...
;(function(window){
	...
	if( !('km' in window) ) window.km={};
	if( !('lib' in window.km) ) window.km.lib={};
...
var 
	kmCore = {
		...
		unsetData: function(){
			...
			if( data ){
				...
				if( (data=kmCore.getData.apply(this, args)) ) delete data[key];
			}
		},
		isDefined: function(){
			var args=kmCore.args2array(arguments)
	...
	*/
	...
	window.kmStorage = km.lib.Storage = Storage;
})(window);
